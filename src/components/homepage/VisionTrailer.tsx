...
export function VisionTrailer() {
  return (
    <div className="py-12 sm:py-16 md:py-20 lg:py-24 text-center bg-gradient-to-b from-background to-indigo-950/10">
      <div className="container">
        ...
        <FloatingCard className="max-w-4xl mx-auto aspect-video relative overflow-hidden group cursor-pointer" hoverEffect="subtle">
          <Image
